            ...
            <div className="container">
                ...
                <div className="grid grid-cols-3 gap-7">
                    <div className="card shadow-md">
                        <div className="card-body space-y-4 items-center text-center">
                            <div className="">
                    ...
                    <div className="card shadow-md">
                        <div className="card-body space-y-4 items-center text-center">
                            <div className="flex">
                                <p className="text-right badge text-white h-10 w-10 rounded-full bg-linear-to-r from-[rgb(79,57,246)] to-[rgb(149,20,250)] font-bold">03</p>
                            </div>
                            <div className="bg-linear-to-r from-[rgba(79,57,246,0.1)] to-[rgba(149,20,250,0.1)] w-25 h-25 rounded-full flex justify-center items-center">
